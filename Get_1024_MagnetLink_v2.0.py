...
if __name__ == "__main__":
    ...
    for page in range(1, 2):
        ...
        # print(mainDivContant)

        for subNode in mainDivContant:


            if "置顶帖标志" not in str(subNode):
                ...
                postNode["id"] = subNode.h3.a["id"]
                postNode["title"] = subNode.h3.a.text.replace("\xa0", "")
                postNode["href"] = "{0}/{1}".format(POST_ROOT_URL, subNode.h3.a["href"])
